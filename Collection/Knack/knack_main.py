...
#pngs
kreuz7 = pygame.image.load(r"Knack_Assats\7C.png").convert()
kreuz7 = pygame.transform.scale(kreuz7, (100, 100))
karo7 = pygame.image.load(r"Knack_Assats\7D.png").convert()
karo7 = pygame.transform.scale(karo7, (100, 100))
pik7 = pygame.image.load(r"Knack_Assats\7S.png").convert()
pik7 = pygame.transform.scale(pik7, (100, 100))
herz7 = pygame.image.load(r"Knack_Assats\7H.png").convert()
herz7 = pygame.transform.scale(herz7, (100, 100))

kreuz8 = pygame.image.load(r"Knack_Assats\8C.png").convert()
kreuz8 = pygame.transform.scale(kreuz8, (100, 100))
karo8 = pygame.image.load(r"Knack_Assats\8D.png").convert()
karo8 = pygame.transform.scale(karo8, (100, 100))
pik8 = pygame.image.load(r"Knack_Assats\8S.png").convert()
pik8 = pygame.transform.scale(pik8, (100, 100))
herz8 = pygame.image.load(r"Knack_Assats\8H.png").convert()
herz8 = pygame.transform.scale(herz8, (100, 100))

kreuz9 = pygame.image.load(r"Knack_Assats\9C.png").convert()
kreuz9 = pygame.transform.scale(kreuz9, (100, 100))
karo9 = pygame.image.load(r"Knack_Assats\9D.png").convert()
karo9 = pygame.transform.scale(karo9, (100, 100))
pik9 = pygame.image.load(r"Knack_Assats\9S.png").convert()
pik9 = pygame.transform.scale(pik9, (100, 100))
herz9 = pygame.image.load(r"Knack_Assats\9H.png").convert()
herz9 = pygame.transform.scale(herz9, (100, 100))

kreuz10 = pygame.image.load(r"Knack_Assats\10C.png").convert()
kreuz10 = pygame.transform.scale(kreuz10, (100, 100))
karo10 = pygame.image.load(r"Knack_Assats\10D.png").convert()
karo10 = pygame.transform.scale(karo10, (100, 100))
pik10 = pygame.image.load(r"Knack_Assats\10S.png").convert()
pik10 = pygame.transform.scale(pik10, (100, 100))
herz10 = pygame.image.load(r"Knack_Assats\10H.png").convert()
herz10 = pygame.transform.scale(herz10, (100, 100))

kreuzb = pygame.image.load(r"Knack_Assats\JC.png").convert()
kreuzb = pygame.transform.scale(kreuzb, (100, 100))
karob = pygame.image.load(r"Knack_Assats\JD.png").convert()
karob = pygame.transform.scale(karob, (100, 100))
pikb = pygame.image.load(r"Knack_Assats\JS.png").convert()
pikb = pygame.transform.scale(pikb, (100, 100))
herzb = pygame.image.load(r"Knack_Assats\JH.png").convert()
herzb = pygame.transform.scale(herzb, (100, 100))

kreuzd = pygame.image.load(r"Knack_Assats\QC.png").convert()
kreuzd = pygame.transform.scale(kreuzd, (100, 100))
karod = pygame.image.load(r"Knack_Assats\QD.png").convert()
karod = pygame.transform.scale(karod, (100, 100))
pikd = pygame.image.load(r"Knack_Assats\QS.png").convert()
pikd = pygame.transform.scale(pikd, (100, 100))
herzd = pygame.image.load(r"Knack_Assats\QH.png").convert()
herzd = pygame.transform.scale(herzd, (100, 100))

kreuzk = pygame.image.load(r"Knack_Assats\KC.png").convert()
kreuzk = pygame.transform.scale(kreuzk, (100, 100))
karok = pygame.image.load(r"Knack_Assats\KD.png").convert()
karok = pygame.transform.scale(karok, (100, 100))
pikk = pygame.image.load(r"Knack_Assats\KS.png").convert()
pikk = pygame.transform.scale(pikk, (100, 100))
herzk = pygame.image.load(r"Knack_Assats\KH.png").convert()
herzk = pygame.transform.scale(herzk, (100, 100))

kreuza = pygame.image.load(r"Knack_Assats\AC.png").convert()
kreuza = pygame.transform.scale(kreuza, (100, 100))
karoa = pygame.image.load(r"Knack_Assats\AD.png").convert()
karoa = pygame.transform.scale(karoa, (100, 100))
pika = pygame.image.load(r"Knack_Assats\AS.png").convert()
pika = pygame.transform.scale(pika, (100, 100))
herza = pygame.image.load(r"Knack_Assats\AH.png").convert()
