...
GREEN_LASER = pygame.image.load(os.path.join("SpaceInvaders_Assets/pixel_laser_green.png"))
BLUE_LASER = pygame.image.load(os.path.join("SpaceInvaders_Assets/pixel_laser_blue.png"))
YELLOW_LASER = pygame.image.load(os.path.join("SpaceInvaders_Assets/pixel_laser_yellow.png"))

#Hintergrund laden
BG = pygame.transform.scale(pygame.image.load(os.path.join("SpaceInvaders_Assets/background-black.png")), (WIDTH, HEIGHT))
...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("Du bist ein René!!", 1, (255,255,255))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Linke Maustaste drücken um zu starten", 1, (255,255,255))
